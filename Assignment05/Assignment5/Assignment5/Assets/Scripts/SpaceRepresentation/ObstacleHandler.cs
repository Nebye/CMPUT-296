...
public class ObstacleHandler : MonoBehaviour
{
	...
	public float Width { get { return 2f; } }
	public float Height { get { return 2.5f; } }
	...
	private Polygon CreateObstacle(ProtoObstacle virtualObstacle, string obstacleName = "")
	{
		GameObject newObstacleObj = GameObject.Instantiate(protoObstacle);
		if (obstacleName.Length > 0)
		{
		...
		Polygon obstacle = newObstacleObj.GetComponent<Polygon>();
		obstacle.SetUpPolygon(virtualObstacle.GetPoints(), virtualObstacle.lineWidth, virtualObstacle.lineColor);
	...
	private void CreateAndRenderObstacle(ProtoObstacle virtualObstacle, string obstacleName = "")
	{
		Polygon newObstacle = CreateObstacle(virtualObstacle, obstacleName);
		newObstacle.RenderObstacle();
	}

	public void CreateAndRenderObstacles(ProtoObstacle[] arrayOfVirtualObjectacles)
	{
		for (int o = 0; o < arrayOfVirtualObjectacles.Length; o++)
		{
			ProtoObstacle p = arrayOfVirtualObjectacles[o];
			CreateAndRenderObstacle(p, "Obstacle " + o);
		}
	}
